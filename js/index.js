...
const displayMeals = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    cards += `
        <div class="col-md-3">
                <div onclick="getMealDetails('${arr[i].idMeal}')" class="card position-relative overflow-hidden rounded-2 cursor-pointer">
...
const displayCategories = (arr) => {
    ...
    categoryCards += `
        <div class="col-md-3">
                <div onclick="getCategoryMeals('${
                  arr[i].strCategory
                }')" class="card position-relative overflow-hidden rounded-2 cursor-pointer">
                    <img class="w-100" src="${
                      arr[i].strCategoryThumb
                    }" alt="" srcset="">
                    <div class="card-layer position-absolute text-center text-black p-2">
  ...
  rowData.innerHTML = categoryCards;
};
